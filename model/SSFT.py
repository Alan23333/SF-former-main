...
class CAT_Unet(nn.Module):
    def __init__(self,
        ...
        self.c_attns1 = CAB(num_feat=dim)
        self.c_attns2 = CAB(num_feat=int(dim * 2 ** 1))
        self.c_attns3 = CAB(num_feat=int(dim * 2 ** 2))
    ...
    def forward(self, inp_img):  # inp_img(10,96,96)
        ...
        out_enc_level1 = self.c_attns1(out_enc_level1)
        out_enc_level2 = self.c_attns2(out_enc_level2)
        out_enc_level3 = self.c_attns3(out_enc_level3)
